  ...
  _applyStepDirectPushPullValue(mode, value, drag) {
    ...
    if (mode === "width") {
      ...
      if (this.isCenteredCircularStepShape?.()) {
        ...
        // Rectangle/radius narrow treads use stepExtension as their default
        // straight run length. Radius corners remain a fixed 300 mm geometry
        // radius in the shape builders; any extra run is straight extension
        // behind it.
