...
/* -------------------------------------------------------
  ...
  if (stepCount > 0) {
    ...
    for (let s = 0; s < stepCount; s++) {
      ...
      const radiusNoseRun = isRadiusExtensionStep ? Math.min(0.3, Math.max(0.05, stepRun)) : stepRun;
      const straightExtensionRun = isRadiusExtensionStep ? Math.max(0, stepRun - radiusNoseRun) : 0;
      ...
      if (isRadiusExtensionStep && straightExtensionRun > 0.01) {
        ...
        const extensionDistanceFromWall = distanceFromWall - (stepRun * 0.5) + (straightExtensionRun * 0.5);
      ...
      const noseDistanceFromWall = isRadiusExtensionStep
        ? distanceFromWall + (stepRun * 0.5) - (radiusNoseRun * 0.5)
        : distanceFromWall;
