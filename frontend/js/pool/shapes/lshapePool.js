...
/* -------------------------------------------------------
  ...
  if (stepCount > 0) {
    ...
    for (let s = 0; s < stepCount; s++) {
      ...
      const isRadiusExtensionStep = params?.stepShape === "radius" && !isBenchSeat && !circularWallFollow;
      ...
      if (isRadiusExtensionStep && straightExtensionRun > 0.01) {
        ...
        const extensionDistanceFromWall = straightExtensionRun * 0.5;
      ...
      const noseDistanceFromWall = isRadiusExtensionStep
        ? straightExtensionRun + radiusNoseRun * 0.5
        : distanceFromWall;
